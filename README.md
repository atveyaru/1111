...
# Задание 1 (файл Тесты по PLSQL-SQL.DOC)
...
Ответ:
* DML внутри функций - ЗЛО 
* запускать ей можно только внутри автономной транзакции
...
Ответ:
Это функции которые возвращают данные в виде коллекции и к ним можно обратиться в предложении FROM.
Применяются если нужно преобразовать данные и обратиться к ним в SQL-запросе.
Табличные функции бывают
* потоковые (поточные)
* конвейерные 
